import numpy as np
from week1code import get_mic_samples, get_spec, get_mp3_samples
...
def transcribe_audio(listen_time):
    samples = get_mic_samples(listen_time)
    spectrogram, freqs, times = get_spec(samples, 44100)
